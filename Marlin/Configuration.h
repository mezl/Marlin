...
#define STRING_CONFIG_H_AUTHOR "(kai, CR-10p)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 988.67 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25, -41, -3.5 }
...
#define HOMING_FEEDRATE_MM_M { (40*60), (20*60), (8*60) }
